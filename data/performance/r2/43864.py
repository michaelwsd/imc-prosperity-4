...
class Trader:
    ...
    def trade_emeralds(self, state: TradingState, product: str) -> List[Order]:
        ...
        buy_price = fair - self.EMERALDS_MM_EDGE       # 9997
        sell_price = fair + self.EMERALDS_MM_EDGE       # 10003
    ...
    def trade_tomatoes(self, state: TradingState, product: str, saved: dict) -> List[Order]:
        ...
        if saved["tomatoes_ema"] is None:
            saved["tomatoes_ema"] = midprice
        else:
            saved["tomatoes_ema"] = alpha * midprice + (1 - alpha) * saved["tomatoes_ema"]
